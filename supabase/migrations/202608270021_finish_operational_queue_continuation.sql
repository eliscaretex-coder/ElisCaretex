-- Keep the Finish operational list continuous across delayed and early physical work.
-- Past customers appear only while there is unresolved physical work; future customers
-- appear only once they have entered the physical production flow.
...
begin
  ...
  return jsonb_build_object(
    'schema_version','FINISH_OPERATIONAL_QUEUE_V2',
