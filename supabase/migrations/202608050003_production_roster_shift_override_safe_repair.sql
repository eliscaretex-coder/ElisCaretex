-- =====================================================================
-- ElisCaretex V2
-- Migration: 202608050003_production_roster_shift_override_safe_repair.sql
-- Purpose:
--   - Safely complete the shift-override schema after an earlier failed
--     backfill attempt, without modifying any existing roster entry row.
...
-- IMPORTANT: This repair migration contains no UPDATE or DELETE statement
-- against public.production_roster_entries. Existing published history is
-- read through fallback expressions and remains physically unchanged.
